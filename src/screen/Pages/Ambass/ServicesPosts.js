        ...
        <div className="bg-theme">
          <div className="main-wrapper">
            <div className="container py-4">
              <h5 className='kk ps-3'>Manage Posts</h5>
              ...
              <div className="min-box my-4">
                <div className="products-table">
                  <table className="table border rounded align-middle" style={{ borderColor: "#4f4f51" }}>
...
Trainer</td>
                        ...
                        <td>625</td>
                        <td><span className='text-ligh  ' style={{ color:"#278a1a", fontSize:"10px" ,backgroundColor: "#41ff2848",  borderRadius: 20, padding: '5px 10px' }}>Active</span></td>
